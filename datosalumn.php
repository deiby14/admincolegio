...
// Lista blanca para los valores permitidos
...
<div class="top-right-button">
    ...
    <form method="GET" action="">
        ...
        <div class="filtro-todos">
            <label for="filtro_todos">Seleccionar criterio de orden:</label>
        ...
        <div class="filtro-todos">
            ...
            <select id="filtro_sexo" name="filtro_sexo">
                ...
                <option value="M" <?php if ($filtro_sexo == 'M') echo 'selected'; ?>>Masculino</option>
                <option value="F" <?php if ($filtro_sexo == 'F') echo 'selected'; ?>>Femenino</option>
            </select>
        </div>
